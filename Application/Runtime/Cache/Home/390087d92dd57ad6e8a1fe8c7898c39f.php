            ...
            <div class="function clearfix">
                <div class="col-sm-3 col-xs-3 co-md-3 col-lg-3">
                    ...
                    <ul class="nav nav-pills nav-stacked">
                        ...
                        <li role="presentation" class="active"><a href="/tp_GeneralEducation/index.php/Home/Teacher/teacher_password/">修改密码</a></li>
                ...
                <div class="col-sm-9 col-xs-9 co-md-9 col-lg-9">
                    <form class="changePassword" method="POST" action="/tp_GeneralEducation/index.php/Home/Teacher/post_password/">
