            ...
            <div class="function clearfix">
                <div class="col-sm-3 col-xs-3 co-md-3 col-lg-3">
                    ...
                    <ul class="nav nav-pills nav-stacked">
                        ...
                        <li role="presentation" class="active"><a href="/tp_GeneralEducation/index.php/Home/Teacher/teacher_discuss/">发布问题</a></li>
                ...
                <div class="col-sm-9 col-xs-9 co-md-9 col-lg-9">
                    <p style="font-size:20px;font-weight: 900;color:#ff0000">此处实现教师发布问题</p>
                </div>
            </div>
        </div>
