                ...
                <div class="function clearfix">
                    ...
                    <div class="col-sm-9 col-xs-9 co-md-9 col-lg-9">
                        <ul class="user-tab clearfix">
                            ...
                            <li  style="background-color:#A89C6B;color:#FFFFFF"><a href="/tp_GeneralEducation/index.php/Home/Admin/admin_user_stu/">学生管理</a></li>
                        ...
                        <div class="user-show clearfix">
                           <table class="table">
                              ...
                              <?php if(is_array($select)): foreach($select as $key=>$user): ?><tr>
                                    ...
                                    <td class="user-delete"><a href='<?php echo U("user_delete_tea", array("id" => $user["pk_teacher"]));?>'>删除</a></td>
                        ...
                        <div class="user-add">
                            <button class="btn btn-default" data-toggle="modal" data-target="#myModal"  style="float:right;margin-bottom:10px;">添加教师</button>
                            <div class="modal fade user-add-modal" id="myModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                        <p>须知：请根据模板将角色信息填入excel表格中再上传导入，<a href='<?php echo U("file_tea");?>'>点此下载模板</a></p>
                                        <form class="user-add-form clearfix"  action="<?php echo U('add_tea');?>" enctype="multipart/form-data" method="post">
