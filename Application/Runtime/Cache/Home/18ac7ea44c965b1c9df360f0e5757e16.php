    ...
    <div class="content">
        <div class="col-xs-12 col-md-8 col-lg-8 col-md-offset-2 col-lg-offset-2">
            ...
            <ul class="dataList clearfix">
                <?php if(is_array($dataList)): foreach($dataList as $key=>$list): ?><li title="<?php echo ($list["title"]); ?>"><a href='<?php echo U("anno_content", array("id" => $list["pk_sources"]));?>'><?php echo ($list["title"]); ?></a><span style="float:right"><?php echo ($list["ts"]); ?></span></li><?php endforeach; endif; ?>
            </ul>
