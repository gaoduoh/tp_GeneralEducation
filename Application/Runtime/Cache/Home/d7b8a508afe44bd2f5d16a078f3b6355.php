...
<body>
    <div class="main clearfix">
        ...
        <div class="content clearfix">
            <p class="welcome"><a href="/tp_GeneralEducation/index.php/Home/Student/../Index/index/">首页</a><span>&gt;&gt</span><span><span><?php echo ($username); ?></span>同学，欢迎你！</span><a href="/tp_GeneralEducation/index.php/Home/Student/../Index/loginout/">退出</a></p>
            <div class="function clearfix">
                <div class="col-sm-3 col-xs-3 co-md-3 col-lg-3">
                    ...
                    <li role="presentation" class="active"><a href="/tp_GeneralEducation/index.php/Home/Student/student_discuss/">问题讨论</a></li>
                ...
                <div class="col-sm-9 col-xs-9 co-md-9 col-lg-9">
                    <p style="font-size:20px;font-weight: 900;color:#ff0000">此处实现学生问题讨论</p>
                </div>
            </div>
        </div>
