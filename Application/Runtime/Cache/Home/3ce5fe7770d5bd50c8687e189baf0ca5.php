        ...
        <div class="content clearfix">
            ...
            <div class="function clearfix">
                ...
                <div class="col-sm-9 col-xs-9 co-md-9 col-lg-9">
                    ...
                    <form method="POST" action="/tp_GeneralEducation/index.php/Home/Teacher/searchData">
                        <input type="text" name="key"/>
                        <button type="submit" name="searchBtn"><i class="fa fa-search"></i>搜索</button>
                    </form>
                    <ul class="dataList clearfix">
                      <?php if(is_array($select)): foreach($select as $key=>$list): ?><li style="width:90%;margin:5px 0"><?php echo ($list["title"]); ?><a style="float:right" href='<?php echo U("delete_file", array("id" => $list["pk_sources"]));?>'>删除</a></li><?php endforeach; endif; ?>
                    </ul>
